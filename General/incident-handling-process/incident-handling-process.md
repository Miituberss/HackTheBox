- [Incident Handling](#incident-handling)
	- [Incident Handling Definition & Scope](#incident-handling-definition--scope)
	- [Incident Handling's Value & Generic Notes](#incident-handlings-value--generic-notes)
	- [Different Types of Real-World Incidents](#different-types-of-real-world-incidents)
	- [Example of Incident Reports](#example-of-incident-reports)
	- [Incident Scenario](#incident-scenario)
- [Cyber Kill Chain](#cyber-kill-chain)
	- [What Is The Cyber Kill Chain?](#what-is-the-cyber-kill-chain)
	- [Stages of the Cyber Kill Chain](#stages-of-the-cyber-kill-chain)
	- [MITRE ATT&CK Framework](#mitre-attck-framework)
	- [MITRE ATT&CK integration in TheHive](#mitre-attck-integration-in-thehive)
	- [Example of MITRE ATT&CK Mapping](#example-of-mitre-attck-mapping)
...
- [Preparation Stage (Part 1)](#preparation-stage-part-1)
	...
	- [Tools (Software & Hardware)](#tools-software--hardware)
- [Preparation Stage (Part 2)](#preparation-stage-part-2)
	...
	- [Active Directory Security Assessment](#active-directory-security-assessment)
...
- [Containment, Eradication, and Recovery Stage](#containment-eradication-and-recovery-stage)
...
- [Post-Incident Activity Stage](#post-incident-activity-stage)
	...
	- [Environment & Important Assets](#environment--important-assets)
	- [Incident Analysis](#incident-analysis)
	- [Immediate Incident Response Actions](#immediate-incident-response-actions)
	- [Mapping to MITRE ATT&CK](#mapping-to-mitre-attck)
	- [Lessons Learned](#lessons-learned)
- [Skills Assessment](#skills-assessment)
	- [Triage the alerts](#triage-the-alerts)
	- [Mapping to the Cyber Kill Chain](#mapping-to-the-cyber-kill-chain)
	- [Investigate the collected logs](#investigate-the-collected-logs)
...
![Incident Response Life Cycle flowchart: Preparation → Detection and Analysis → Containment, Eradication, and Recovery → Post‑Incident Activity, with arrows showing feedback loops from each stage back to earlier stages and to Preparation for continuous improvement. Title beneath: “Incident Response Life Cycle Model.”](https://academy.hackthebox.com/storage/modules/148/ir-lifecycle.png)
...
![The DFIR Report homepage showing three featured articles in a grid beneath a red header with navigation.](https://academy.hackthebox.com/storage/modules/148/dfirreport.png)
...
![TheHive “Alerts” page in Firefox at http://10.129.234.131:9000/alerts showing 43 alerts. Two visible alerts read “Possible suspicious access to Windows admin shares,” status New, type wazuh_alert from source wazuh. Details show rule=92105, agent_name=SCDC01, agent_id=005, agent_ip=172.16.200.50, references a130aa and fa3660, Observables count 1, TTPs 0, created/updated 09/10/2025 04:41 (one updated 10:04). Left sidebar highlights the Alerts icon; top bar includes search and “Create Case+.”](https://academy.hackthebox.com/storage/modules/148/ir_hive1.png)
...
![Flowchart showing investigation process: Initial Investigation Data leads to IOCs, Compromised Systems, and Collection & Analysis.](https://academy.hackthebox.com/storage/modules/148/ir-ioc.png)
...
Note: We will explore the reporting part of the Incident Handling Process in more detail in the `Security Incident Reporting` module of the `SOC Analyst` job role path.# Analysis of Insight Nexus Breach
...
![TheHive case interface showing a “Comments” panel with a pasted netstat -ano snippet from host 10.10.5.23. Entries include TCP 127.0.0.1:5357 LISTENING, TCP 10.10.5.23:139 LISTENING, outbound TCP 10.10.5.23:52344 → 198.5.x.x:443 ESTABLISHED, 10.10.5.23:52345 → 203.0.x.x:4444 ESTABLISHED, UDP 10.10.5.23:123 listening, and SMB connections to 10.10.5.17:445 and 10.10.5.18:445 (ESTABLISHED/TIME_WAIT). Top bar shows controls (Create Case, language EN-UK, user HTB-ANALYST).](https://academy.hackthebox.com/storage/modules/148/ir-netstat.png)
