- [Network Traffic Analysis](#network-traffic-analysis)
  - [Required Skills and Knowledge](#required-skills-and-knowledge)
      ...
      - [Concepts of IP Packets and the Sublayers](#concepts-of-ip-packets-and-the-sublayers)
      - [Protocol Transport Encapsulation](#protocol-transport-encapsulation)
  - [Environment and Equipment](#environment-and-equipment)
      - [Common Traffic Analysis Tools](#common-traffic-analysis-tools)
  - [BPF Syntax](#bpf-syntax)
  - [Performing Network Traffic Analysis](#performing-network-traffic-analysis)
      - [NTA Workflow](#nta-workflow)
      - [NTA Workflow](#nta-workflow-1)
      - [1. Ingest Traffic](#1-ingest-traffic)
      - [2. Reduce Noise by Filtering](#2-reduce-noise-by-filtering)
      - [3. Analyze and Explore](#3-analyze-and-explore)
      - [4. Detect and Alert](#4-detect-and-alert)
      - [5. Fix and Monitor](#5-fix-and-monitor)
- [Networking Primer - Layers 1-4](#networking-primer---layers-1-4)
  - [OSI / TCP-IP Models](#osi--tcp-ip-models)
      - [Networking Models](#networking-models)
      - [Model Traits Comparison.](#model-traits-comparison)
      - [PDU Example](#pdu-example)
      - [PDU Packet Breakdown](#pdu-packet-breakdown)
  ...
  - [IP Addressing](#ip-addressing)
      ...
      - [IPv6 Addressing Types](#ipv6-addressing-types)
      - [Adoption of IPv6](#adoption-of-ipv6)
  - [TCP / UDP, Transport Mechanisms](#tcp--udp-transport-mechanisms)
      - [TCP vs. UDP](#tcp-vs-udp)
      - [TCP VS. UDP](#tcp-vs-udp-1)
  - [TCP Three-way Handshake](#tcp-three-way-handshake)
      - [TCP Three-way Handshake](#tcp-three-way-handshake-1)
      - [TCP Session Teardown](#tcp-session-teardown)
- [Networking Primer - Layers 5-7](#networking-primer---layers-5-7)
  - [HTTP](#http)
      - [HTTP Methods](#http-methods)
  - [HTTPS](#https)
      - [TLS Handshake Via HTTPS](#tls-handshake-via-https)
  - [FTP](#ftp)
      - [FTP Command \& Response Examples](#ftp-command--response-examples)
      - [FTP Commands](#ftp-commands)
  - [SMB](#smb)
      - [SMB On The Wire](#smb-on-the-wire)
- [The Analysis Process](#the-analysis-process)
  - [Analysis Dependencies](#analysis-dependencies)
      - [Traffic Capture Dependencies](#traffic-capture-dependencies)
- [Analysis in Practice](#analysis-in-practice)
  ...
  - [Key Components of an Effective Analysis](#key-components-of-an-effective-analysis)
      - [1. Know your environment](#1-know-your-environment)
      - [2. Placement is Key](#2-placement-is-key)
      - [3. Persistence](#3-persistence)
  - [Analysis Approach](#analysis-approach)
- [Tcpdump Fundamentals](#tcpdump-fundamentals)
      - [Locate Tcpdump](#locate-tcpdump)
      - [Install Tcpdump](#install-tcpdump)
      - [Tcpdump Version Validation](#tcpdump-version-validation)
  - [Traffic Captures with Tcpdump](#traffic-captures-with-tcpdump)
      - [Basic Capture Options](#basic-capture-options)
      - [Man Page Utilization](#man-page-utilization)
      - [Tcpdump Man Page](#tcpdump-man-page)
      - [Listing Available Interfaces](#listing-available-interfaces)
      - [Choosing an Interface to Capture From](#choosing-an-interface-to-capture-from)
      - [Disable Name Resolution](#disable-name-resolution)
      - [Display the Ethernet Header](#display-the-ethernet-header)
      - [Include ASCII and Hex Output](#include-ascii-and-hex-output)
      - [Tcpdump Switch Combinations](#tcpdump-switch-combinations)
  - [Tcpdump Output](#tcpdump-output)
      - [Tcpdump Shell Breakdown](#tcpdump-shell-breakdown)
  - [File Input/Output with Tcpdump](#file-inputoutput-with-tcpdump)
      - [Save our PCAP Output to a File](#save-our-pcap-output-to-a-file)
      - [Reading Output From a File](#reading-output-from-a-file)
- [Fundamentals Lab](#fundamentals-lab)
  - [Tasks](#tasks)
      - [Task #1](#task-1)
      - [Task #2](#task-2)
      - [Task #3](#task-3)
      - [Task #4](#task-4)
      - [Task #5](#task-5)
- [Tcpdump Packet Filtering](#tcpdump-packet-filtering)
  - [Filtering and Advanced Syntax Options](#filtering-and-advanced-syntax-options)
      - [Helpful TCPDump Filters](#helpful-tcpdump-filters)
      - [Host Filter](#host-filter)
      - [Source/Destination Filter](#sourcedestination-filter)
      - [Utilizing Source With Port as a Filter](#utilizing-source-with-port-as-a-filter)
      - [Using Destination in Combination with the Net Filter](#using-destination-in-combination-with-the-net-filter)
      - [Protocol Filter - Common Name](#protocol-filter---common-name)
      - [Protocol Filter - Number](#protocol-filter---number)
      - [Port Filter](#port-filter)
      - [Port Range Filter](#port-range-filter)
      - [Less/Greater Filter](#lessgreater-filter)
      - [Utilizing Greater](#utilizing-greater)
      - [AND Filter](#and-filter)
      - [Basic Capture With No Filter](#basic-capture-with-no-filter)
      - [OR Filter](#or-filter)
      - [NOT Filter](#not-filter)
  - [Pre-Capture Filters VS. Post-Capture Processing](#pre-capture-filters-vs-post-capture-processing)
  - [Interpreting Tips and Tricks](#interpreting-tips-and-tricks)
      - [Tips and Tricks](#tips-and-tricks)
      - [Piping a Capture to Grep](#piping-a-capture-to-grep)
      - [Looking for TCP Protocol Flags](#looking-for-tcp-protocol-flags)
      - [Hunting For a SYN Flag](#hunting-for-a-syn-flag)
      - [Protocol RFC Links](#protocol-rfc-links)
- [Interrogating Network Traffic With Capture and Display Filters](#interrogating-network-traffic-with-capture-and-display-filters)
  - [Tasks](#tasks-1)
      - [Task #1](#task-1-1)
      - [Task #2](#task-2-1)
      - [Task #3](#task-3-1)
      ...
      - [Task #7](#task-7)
  - [Summary](#summary)
  - [Tips For Analysis](#tips-for-analysis)
- [Analysis with Wireshark](#analysis-with-wireshark)
      - [Features and Capabilities:](#features-and-capabilities)
  - [Requirements for Use](#requirements-for-use)
      - [Windows:](#windows)
      - [Linux:](#linux)
      - [Locating Wireshark](#locating-wireshark)
      - [Installing Wireshark On Linux](#installing-wireshark-on-linux)
  - [TShark VS. Wireshark (Terminal vs. GUI)](#tshark-vs-wireshark-terminal-vs-gui)
      - [Basic TShark Switches](#basic-tshark-switches)
      - [TShark Help](#tshark-help)
      - [TShark Basic Usage](#tshark-basic-usage)
      - [Locating TShark](#locating-tshark)
      - [Selecting an Interface \& Writing to a File](#selecting-an-interface--writing-to-a-file)
      - [Applying Filters](#applying-filters)
  - [Termshark](#termshark)
      - [Termshark](#termshark-1)
      - [Termshark Help](#termshark-help)
  - [Wireshark GUI Walkthrough](#wireshark-gui-walkthrough)
      - [Wireshark GUI](#wireshark-gui)
      - [Other Notable Features](#other-notable-features)
      - [Wireshark Menu](#wireshark-menu)
  - [Performing our first capture in Wireshark](#performing-our-first-capture-in-wireshark)
      - [Steps To Start A Capture](#steps-to-start-a-capture)
  - [The Basics](#the-basics)
      - [The Toolbar](#the-toolbar)
      - [How to Save a Capture](#how-to-save-a-capture)
  - [Pre-capture and Post-capture Processing and Filtering](#pre-capture-and-post-capture-processing-and-filtering)
      - [Capture Filters](#capture-filters)
      - [Applying a Capture Filter](#applying-a-capture-filter)
      - [Filter List](#filter-list)
      - [Applying A Capture Filter](#applying-a-capture-filter-1)
      - [Display Filters](#display-filters)
      - [Applying a Display Filter](#applying-a-display-filter)
      - [Applying Display Filters](#applying-display-filters)
- [Familiarity With Wireshark](#familiarity-with-wireshark)
  - [Tasks](#tasks-2)
      - [Task #1](#task-1-2)
      - [Task #2](#task-2-2)
      - [Task #3](#task-3-2)
      ...
      - [Task #5](#task-5-2)
  - [Summary](#summary-1)
- [Wireshark Advanced Usage](#wireshark-advanced-usage)
  - [Plugins](#plugins)
      - [The Statistics and Analyze Tabs](#the-statistics-and-analyze-tabs)
      - [Statistics Tab](#statistics-tab)
      - [Analyze](#analyze)
      - [Analyze Tab](#analyze-tab)
      - [Following TCP Streams](#following-tcp-streams)
      - [Follow A Stream Via GUI](#follow-a-stream-via-gui)
  - [Filter For A Specific TCP Stream](#filter-for-a-specific-tcp-stream)
      - [Extracting Data and Files From a Capture](#extracting-data-and-files-from-a-capture)
      - [Extract Files From The GUI](#extract-files-from-the-gui)
      - [FTP Disector](#ftp-disector)
      - [FTP-Request-Command Filter](#ftp-request-command-filter)
      - [FTP-Data Filter](#ftp-data-filter)
- [Packet Inception, Dissecting Network Traffic With Wireshark](#packet-inception-dissecting-network-traffic-with-wireshark)
  - [Tasks](#tasks-3)
      - [Task #1](#task-1-3)
      - [Task #2](#task-2-3)
      - [Task #3](#task-3-3)
  - [Live Capture and Analysis](#live-capture-and-analysis)
  - [Connectivity to Lab](#connectivity-to-lab)
      - [Start a Wireshark Capture](#start-a-wireshark-capture)
      - [Self Analysis](#self-analysis)
      - [FTP Analysis](#ftp-analysis)
      - [Filter the results](#filter-the-results)
      - [HTTP Analysis](#http-analysis)
      - [Follow the stream and extract the item(s) found](#follow-the-stream-and-extract-the-items-found)
  - [Summary](#summary-2)
- [Guided Lab: Traffic Analysis Workflow](#guided-lab-traffic-analysis-workflow)
  - [Tasks:](#tasks-4)
      - [Task #1](#task-1-4)
    - [Analysis](#analysis)
  - [Summary](#summary-3)
- [Decrypting RDP connections](#decrypting-rdp-connections)
  - [Tasks:](#tasks-5)
      - [Task #1](#task-1-5)
      - [Task #2](#task-2-4)
      - [RDP Filter](#rdp-filter)
      - [Task #3](#task-3-4)
      - [Import An RDP Key](#import-an-rdp-key)
      - [Import Steps](#import-steps)
      - [RDP In The Clear](#rdp-in-the-clear)
  - [Perform Analysis of the Unencrypted Traffic](#perform-analysis-of-the-unencrypted-traffic)
      - [Questions:](#questions)
  - [Summary:](#summary-4)
...
```shell-session
Miituberss@htb[/htb]$ which tcpdump
```
...
```shell-session
Miituberss@htb[/htb]$ sudo apt install tcpdump 
```
...
```shell-session
Miituberss@htb[/htb]$ sudo tcpdump --version
...
```shell-session
Miituberss@htb[/htb]$ man tcpdump
```
...
```shell-session
Miituberss@htb[/htb]$ sudo tcpdump -D
...
```shell-session
Miituberss@htb[/htb]$ sudo tcpdump -i eth0
...
```shell-session
Miituberss@htb[/htb]$ sudo tcpdump -i eth0 -nn
...
```shell-session
Miituberss@htb[/htb]$ sudo tcpdump -i eth0 -e
...
```shell-session
Miituberss@htb[/htb]$ sudo tcpdump -i eth0 -X
...
```shell-session
Miituberss@htb[/htb]$ sudo tcpdump -i eth0 -nnvXX
...
```shell-session
Miituberss@htb[/htb]$ sudo tcpdump -i eth0 -w ~/output.pcap
...
```shell-session
Miituberss@htb[/htb]$ sudo tcpdump -r ~/output.pcap
...
```shell-session
Miituberss@htb[/htb]$ ### Syntax: host [IP]
Miituberss@htb[/htb]$ sudo tcpdump -i eth0 host 172.16.146.2
...
```shell-session
Miituberss@htb[/htb]$ ### Syntax: src/dst [host|net|port] [IP|Network Range|Port]
Miituberss@htb[/htb]$ sudo tcpdump -i eth0 src host 172.16.146.2
...
```shell-session
Miituberss@htb[/htb]$ sudo tcpdump -i eth0 tcp src port 80
...
```shell-session
Miituberss@htb[/htb]$ sudo tcpdump -i eth0 dest net 172.16.146.0/24
...
```shell-session
Miituberss@htb[/htb]$ ### Syntax: [tcp/udp/icmp]
Miituberss@htb[/htb]$ sudo tcpdump -i eth0 udp
...
```shell-session
Miituberss@htb[/htb]$ ### Syntax: proto [protocol number]
Miituberss@htb[/htb]$ sudo tcpdump -i eth0 proto 17
...
```shell-session
Miituberss@htb[/htb]$ ### Syntax: port [port number]
Miituberss@htb[/htb]$ sudo tcpdump -i eth0 tcp port 443
...
```shell-session
Miituberss@htb[/htb]$ ### Syntax: portrange [portrange 0-65535]
Miituberss@htb[/htb]$ sudo tcpdump -i eth0 portrange 0-1024
...
```shell-session
Miituberss@htb[/htb]$ ### Syntax: less/greater [size in bytes]
Miituberss@htb[/htb]$ sudo tcpdump -i eth0 less 64
...
```shell-session
Miituberss@htb[/htb]$ sudo tcpdump -i eth0 greater 500
...
```shell-session
Miituberss@htb[/htb]$ ### Syntax: and [requirement]
Miituberss@htb[/htb]$ sudo tcpdump -i eth0 host 192.168.0.1 and port 23
...
```shell-session
Miituberss@htb[/htb]$ ### Syntax: or/|| [requirement]
Miituberss@htb[/htb]$ sudo tcpdump -r sus.pcap icmp or host 172.16.146.1
...
```shell-session
Miituberss@htb[/htb]$ ### Syntax: not/! [requirement]
Miituberss@htb[/htb]$ sudo tcpdump -r sus.pcap not icmp
...
```shell-session
Miituberss@htb[/htb]$sudo tcpdump -Ar telnet.pcap
...
```shell-session
Miituberss@htb[/htb]$ sudo tcpdump -Ar http.cap -l | grep 'mailto:*'
...
```shell-session
Miituberss@htb[/htb]$ tcpdump -i eth0 'tcp[13] &2 != 0'
```
...
```shell-session
Miituberss@htb[/htb]$ sudo tcpdump -i eth0 'tcp[13] &2 != 0'
...
```shell-session
Miituberss@htb[/htb]$ which wireshark
```
...
```shell-session
Miituberss@htb[/htb]$ sudo apt install wireshark 
```
...
```shell-session
Miituberss@htb[/htb]$ which tshark

Miituberss@htb[/htb]$ tshark -D

Miituberss@htb[/htb]$ tshark -i 1 -w /tmp/test.pcap
...
```shell-session
Miituberss@htb[/htb]$ sudo tshark -i eth0 -w /tmp/test.pcap
```
...
```shell-session
Miituberss@htb[/htb]$ sudo tshark -i eth0 -f "host 172.16.146.2"
...
2. On the TLS page, select Edit by RSA keys list → a new window will open. ![Wireshark Preferences window showing TLS settings, including RSA key list and options for reassembling TLS records.](https://academy.hackthebox.com/storage/modules/81/import-ws.png)
